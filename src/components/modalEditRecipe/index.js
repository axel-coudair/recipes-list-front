	...
	addIngredient = () => {
		this.setState({
			ingredients: [
				...
				new Ingredient(null, '', null, '', false)
			]
		})
	}
			...
			<>
				{!this.props.hasOwnProperty('recipe') ? (
					<Grid
						container
						justify="center"
						className={classes.fabsGridNewRecipe}>
						<Grid item>
							<Fab
								color="primary"
								variant="extended"
				...
				<Dialog
					...
					<DialogContent>
						<form onSubmit={this.handleSubmit}>
							...
							/>
							<FormControl autoFocus margin="dense" fullWidth>
								<InputLabel htmlFor="numberOfEatersId">
									Nombre de Personnes
								</InputLabel>
								<Select
									name="numberOfEaters"
							...
							<Typography
								...
								variant="h6"
								className={
									this.state.stapes.length ? '' : classes.hideArraysTitles
								}>
								Étapes
							</Typography>
							...
							<Typography
								...
								variant="h6"
								className={
									this.state.ingredients.length ? '' : classes.hideArraysTitles
								}>
								Ingredients
							</Typography>
...
export default connect(
	null,
	mapDispatchToProps
)(withStyles(styles, { withTheme: true })(ModalEditRecipe))
